package com.example.uasdpm_2011500109_muhamadazizsubarka

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.widget.*

class Inputdatadosen : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_inputdatadosen)
        ...
        btnSimpan.setOnClickListener {
            if ("${etNIDN.text}".isNotEmpty() && "${etNmDosen.text}".isNotEmpty() &&
                ...
                val db = Database(this@Inputdatadosen)
                db.Nidn = "${etNIDN.text}"
